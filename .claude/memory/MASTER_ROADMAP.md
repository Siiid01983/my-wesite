...
> Last updated: 2026-06-07 (Phase 20)
...
|---|---|---|---|
| 20 | `5a5e825` | 2026-06-07 | Staff management: multi-account login; roles (admin/staff/read-only); Auth staff CRUD; read-only write guard on all Adapter write paths; _applyRoleToSidebar(); スタッフ管理 view with add/edit/delete/PW-reset modal |
