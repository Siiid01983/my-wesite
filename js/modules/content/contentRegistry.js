...
const CONTENT_REGISTRY = [
  ...
  { group:'お約束カード', key:'commit_card2_body',  label:'カード2 説明文', def:'床・壁・家具を傷つけないための養生を徹底。すべてのお荷物を自分の大切な物を扱うように丁寧にお取り扱いいたします。' },
  { group:'お約束カード', key:'commit_card3_title', label:'カード3 見出し', def:'料金は、明朗に' },
  { group:'お約束カード', key:'commit_card3_body',  label:'カード3 説明文', def:'追加料金が発生する可能性がある場合は、お見積もり時に必ずご説明いたします。当日の追加請求（不当な請求）は一切ございません。' },
  ...
  { group:'お約束カード', key:'commit_card6_title', label:'カード6 見出し', def:'近隣の方々への配慮も、私たちの仕事のうちです。' },
  { group:'お約束カード', key:'commit_card6_body',  label:'カード6 説明文', def:'ご挨拶から作業中の所作まで節度ある丁寧な立ち振る舞いを徹底いたします。' },
  ...
  { group:'引越しの流れセクション', key:'process_lead',    label:'説明文',        def:'ご相談からお引越し完了まで、チャットを中心にわかりやすくサポートいたします。' },

  { group:'引越しの流れステップ', key:'process_step1_title', label:'ステップ1 見出し', def:'お問い合わせ' },
  { group:'引越しの流れステップ', key:'process_step1_body',  label:'ステップ1 説明文', def:'チャットからお気軽にお問い合わせください。ご質問やご希望など、何でもご相談いただけます。' },
  { group:'引越しの流れステップ', key:'process_step2_title', label:'ステップ2 見出し', def:'チャットでご相談・無料お見積り' },
  { group:'引越しの流れステップ', key:'process_step2_body',  label:'ステップ2 説明文', def:'お引越しの内容をチャットで確認し、必要に応じて写真などもお送りいただきながら、最適なお見積りをご案内します。' },
  { group:'引越しの流れステップ', key:'process_step3_title', label:'ステップ3 見出し', def:'お引越し前のご準備' },
  { group:'引越しの流れステップ', key:'process_step3_body',  label:'ステップ3 説明文', def:'当日の流れや必要な準備について、チャットでわかりやすくご案内いたします。' },
  { group:'引越しの流れステップ', key:'process_step4_title', label:'ステップ4 見出し', def:'引越し当日' },
  { group:'引越しの流れステップ', key:'process_step4_body',  label:'ステップ4 説明文', def:'養生・搬出・搬入・設置まで、経験のあるスタッフが丁寧に対応いたします。' },
  { group:'引越しの流れステップ', key:'process_step5_title', label:'ステップ5 見出し', def:'完了・最終確認' },
  { group:'引越しの流れステップ', key:'process_step5_body',  label:'ステップ5 説明文', def:'作業完了後、お客様と最終確認を行います。お引越し後には、メールで評価のご案内をお送りします。' },
